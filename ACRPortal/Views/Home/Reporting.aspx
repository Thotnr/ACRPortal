        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-6 col-lg-12">
                <div class="authority-toolbar-controls">
                    ...
                    <select id="reportStatusFilter" class="form-select table-select status-filter">
                    ...
                    <button type="button" id="reportResetFiltersBtn" class="btn btn-outline-secondary table-select reset-filter" title="Reset filters" style="min-width:72px; padding:0 12px;">Reset</button>
                    <select id="reportPageSizeSelect" class="form-select table-select page-size-filter">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul class="nav nav-tabs" id="reportTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="officer-info-tab" data-bs-toggle="tab" data-bs-target="#officerInfoTab" type="button" role="tab">Officer Info</button>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content mt-3">
                        ...
                        <div class="tab-pane fade" id="officerInfoTab" role="tabpanel">
                            <div class="form-section">
                                <div class="section-heading">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="selfSubmitted" class="form-control" readonly>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label fw-bold">Submitted At</label>
                                        <input type="text" id="selfSubmittedAt" class="form-control" readonly>
                                    </div>
                                    <div class="col-md-12">
...
$(document).ready(function(){
    ...
    $("#reportResetFiltersBtn").on("click", function () {
    ...
    $.ajax({
        ...
        success: function(res){
            if(res.Success){
                ...
                bindOfficerInfo(data.SelfAppraisal);
