...
<div class="col-lg-8">
<span class="master-kicker"><i class="fa fa-globe"></i> Masters</span>
<h2 class="master-title">Manage zone records in a more readable administrative layout.</h2>
<p class="master-subtitle">Search, sort, and maintain zone data from a page that now follows the same refreshed shell used across the portal.</p>
</div>
<div class="col-lg-4">
<div class="master-panel">
<div class="master-panel-label">Master Module</div>
<div class="master-panel-value">Zone</div>
<p class="master-panel-copy">Only the UI is refreshed here, so your existing zone create and update flow remains unchanged.</p>
</div>
</div>
</div>
</div>
...
<div class="page-subtitle">Maintain zone identifiers and names that drive the location hierarchy.</div>
</div>
